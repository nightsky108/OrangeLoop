...
public class DisplayOrganization extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_organization);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(extras !=null)
        {
            int Value = extras.getInt("id");
            if(Value>0){
                getMenuInflater().inflate(R.menu.display_orgnaization, menu);
            }
